...
#define TRIGTOBEAM_DLY_REG 0xF0
#define TRIGTOBEAM_THRESH_REG 0xF4
...
#define DMA_TRIG_DLY_REG 0x164
#define EVENT_SRC_SEL_REG 0x168
#define TEST_TRIG_DLY_REG 0x170
#define TEST_TRIG_WID_REG 0x174
